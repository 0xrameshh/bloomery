...
There's also [teich](https://github.com/TeichAI/teich) which does this and a lot more. bloomery is narrower: it just converts traces. The tradeoff is speed, memory, and being a single ~8 MB binary with no dependencies.
